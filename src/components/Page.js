  ...
  const drawer = (
    <div>
      <List>
        ...
        <ListItem disablePadding>
        <a href="https://github.com/solanatv/solanatv-app" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit' }}>
      ...
      <ListItem disablePadding>
        <a href="https://docs.solanatv.io" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', color: 'inherit' }}>
        <ListItemButton onClick={handleDrawerToggle}>
      <ListItemIcon>
        <MenuBookIcon />
      </ListItemIcon>
