      ...
      {playlistCount !== null ? (
        playlistCount === 0 ? (
          ...
          >
            ...
            <img 
            src="https://raw.githubusercontent.com/solanatv/solanatv-app/main/screenshots/solana-banner.png" 
            alt="Playlist management illustration" 
            style={{ width: '50%', height: 'auto', marginTop: '16px' }}
            />
          </Box>
        ) : null
      ) : null}
